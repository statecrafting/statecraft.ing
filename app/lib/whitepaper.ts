...
// OAP-era paper to describe the real Stagecraft family. Every claim is
...
export const paperMeta = {
  slug: "stagecraft-ecosystem",
  title: "The Stagecraft Ecosystem",
  subtitle: "How a governed agentic delivery control plane is built in the open",
  author: "Bartek Kus",
  date: "July 16, 2026",
  abstract:
    "Stagecraft is a governed control plane for agentic software delivery. It is built around one loop: intent becomes a governed spec, a contract stamps a complete application from an open template, a fleet operates the result, and a tamper-evident record makes the whole run checkable by someone who trusts none of it. This paper walks the mechanisms that make that loop honest, from the spec spine that governs every repo in the family (including this website) to the identity, decision, and attestation primitives that keep humans and agents on the same rails. Where a piece is designed but not yet shipped, it is marked as such: the status ladder on the home page rolls up from the specs, not from this paper.",
};
    ...
    subsections: [
      {
        ...
        content: [
          "The foundation of Stagecraft is the spec spine. Unlike documentation that drifts from the code it describes, the spine is the authoritative design record. Every feature, refactor, or infrastructure change is anchored to a markdown document that explicitly declares its territory. [ref:2]",
    ...
    subsections: [
      {
        ...
        content: [
          "Stagecraft turns intent into software through a governed loop. First **specify**: spec-spine compiles what a human wants into a typed, hash-verifiable spec. This runs today across the family. [ref:2]",
    ...
    subsections: [
      {
        ...
        content: [
          "Compliance in an agentic system needs verifiable proof, not promises. Stagecraft records what the plane did in attest-ledger: an append-only, hash-linked, Ed25519-signed record where each entry commits to the one before it, so a silent edit anywhere in the history breaks the chain. [ref:4]",
    ...
    subsections: [
      {
        ...
        content: [
          "Collaboration between people and agents needs one trust fabric. Stagecraft uses Rauthy as the sole OpenID Connect session signer, with GitHub as an upstream identity provider. A developer's GitHub login federates through Rauthy, giving one centralized source of identity truth. This runs today: the OIDC signer is live at auth.stagecraft.ing. [ref:6]",
...
export const references: Reference[] = [
  { id: 1, label: "STAGECRAFT", title: "Stagecraft: the governed delivery control plane", url: "https://github.com/stagecraft-ing/stagecraft", accessed: "July 2026" },
  { id: 2, label: "SPEC-SPINE", title: "spec-spine: the spec-governance toolchain", url: "https://github.com/stagecraft-ing/spec-spine", accessed: "July 2026" },
  { id: 3, label: "ENRAHITU", title: "enrahitu: the EnRaHiTu template chassis", url: "https://github.com/stagecraft-ing/enrahitu", accessed: "July 2026" },
  { id: 4, label: "ATTEST-LEDGER", title: "attest-ledger: append-only, hash-linked, Ed25519-signed record", url: "https://github.com/stagecraft-ing/attest-ledger", accessed: "July 2026" },
  { id: 5, label: "TENANT-TAIL", title: "tenant-tail: the independent certificate verifier", url: "https://github.com/stagecraft-ing/tenant-tail", accessed: "July 2026" },
  ...
  { id: 8, label: "ACTION-GATE", title: "action-gate: a deterministic decision gate", url: "https://github.com/stagecraft-ing/action-gate", accessed: "July 2026" },
  { id: 9, label: "CANONICAL-JSON", title: "canonical-keysort-json: canonical JSON at the hash boundary", url: "https://github.com/stagecraft-ing/canonical-keysort-json", accessed: "July 2026" },
];

// Positioning table: how the governed-agentic model differs from established
// delivery paradigms. Each cell in the Stagecraft column names a mechanism that
...
export const comparisonTable = {
  ...
  description:
    "A positioning comparison, not a benchmark. The Stagecraft column names mechanisms that exist in the family or are explicit design commitments.",
  dimensions: [
    "Change authority",
    "Audit trail",
    "Agent's role",
