...
export const identityFlowExplorer: ArchDiagram = {
  ...
  nodes: [
    ...
    { id: "rauthy", label: "Rauthy OIDC", x: 155, y: 110, width: 115, height: 52, description: "The sole OpenID Connect session signer, running today at auth.stagecraft.ing. It federates upstream logins and issues scoped tokens for people and agents alike.", color: "oklch(0.22 0.06 195)" },
